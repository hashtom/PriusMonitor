...
public class ELMBluetoothService {
    ...
    private static final String NAME_SECURE = "ELM327BluetoothSecure";
    private static final String NAME_INSECURE = "ELM327BluetoothInsecure";
            ...
            try {
                if (secure) {
                    ...
                    tmp = mAdapter.listenUsingInsecureRfcommWithServiceRecord(
                            NAME_INSECURE, SPP_UUID_INSECURE);
                }
            } catch (IOException e) {
